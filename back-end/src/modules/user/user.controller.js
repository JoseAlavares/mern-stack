...
mongoose.connect(`mongodb+srv://${USER}:${PASSWORD}@precios-unitarios-dev-rc3gv.gcp.mongodb.net/${DB_NAME}?retryWrites=true&w=majority`, {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        try {
            ...
            userModel.findOne({
                ...
                if(err) return reject({message: "Ocurrio un error en el servidor", error: err, status: 500});
            ...
            console.error(e);
            reject({message: "Ocurrio un error 2", error: e, status: 500});
        }
    });
};
